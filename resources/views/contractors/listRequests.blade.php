                    ...
                    !!json_encode(
                        $Contractor - > map(function($c) {
                            return [
                                ...
                                'contract_adminstarter' => $c - > contract_adminstarter ?? 'غير محدد',
...
'status' => $order->status->name_code ?? 'جديد', 'request_date' => $order->request_date, 'review_user' => $order->reviewer->fullname ?? '-', 'review_date' => $order->review_date ?? '-', 'review_note' => $order->review_note ?? '-', 'accept_user' => $order->accepter->fullname ?? '-', 'accept_date' => $order->accept_date ?? '-', 'accept_note' => $order->accept_note ?? '-', 'rejected_user' => $order->rejecter->fullname ?? '-', 'rejected_date' => $order->rejected_date ?? '-', 'rejected_note' => $order->rejected_note ?? '-', 'note' => $order->note ?? '-', 'price' => $order->price ?? '-',