...
@section('content')
                ...
                <div x-data="contractorModal()" class="relative">
                    ...
                    <div x-show="openModal" x-cloak
                        ...
                        <div x-show="openModal" x-transition
                            ...
                            <!-- محتوى المودال -->
                            <div class="p-6">
                                <form action="{{ route('contractors.store') }}" method="POST" autocomplete="off" enctype="multipart/form-data">
                                    @csrf
  ...
  <path stroke-linecap="round" stroke-linejoin="round" d="M15 14a4 4 0 10-6 0 4 4 0 006 0z" />
  <path stroke-linecap="round" stroke-linejoin="round" d="M12 2v4M10 4h4" />
  <path stroke-linecap="round" stroke-linejoin="round" d="M6 18c0-2.21 3.582-4 6-4s6 1.79 6 4v2H6v-2z" />
</svg>
