...
@section('page-title', 'عرض و اضافة انواع السيارات')
        ...
        <div class="panel mt-6">
                                ...
                                <div class="grid grid-cols-1 gap-6 lg:grid-cols-2">
                                    ...
                                    <div class="space-y-3">
                                        <label class="inline-flex cursor-pointer">
                                            <span class="text-gray-700 dark:text-gray-300">اسم النوع <span
                                                    class="text-danger">*</span></span>
                                        </label>
                                        <input type="text" name="car_type_name" id="car_type_name"
                                            placeholder="أدخل اسم النوع" value="{{ old('car_type_name') }}"
                                    ...
                                    <div class="flex flex-col sm:flex-row justify-end gap-4 mt-8 border-t pt-4 col-span-2">
                                        ...
                                        <button type="submit" name="active" value="NewCarType"
            ...
            <table id="myTable2" class="whitespace-nowrap w-full border border-gray-200">
                <caption class="text-lg font-semibold mb-3 text-gray-700 dark:text-gray-300">
                    انواع السيارات المتوفرة في الشركة
                </caption>
            </table>
        </div>
    </div>
            ...
            Alpine.data('multipleTable', () => ({
                ...
                init() {
                    ...
                    const tableData = {!! json_encode(
                        $CarsType->map(function ($b) {
                            return [
                                'id' => $b->id,
                                'name' => $b->name,
                                'note' => $b->note,
                                'count' => $b->cars_count, // عدد السيارات حسب العلاقة
                            ];
                        }),
                    ) !!};
                        ...
                        columns: [{
                            ...
                            }, // عدد السيارات
                            {
                                ...
                                render: (data) => {
                                    const id = data;
                                    const url =
                                        `/ConcreteERP/cars/${id}&edit_cartype/edit`;
                                    return `
