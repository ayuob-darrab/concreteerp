                                ...
                                <div class="grid grid-cols-1 gap-6 lg:grid-cols-2">
                                    ...
                                    <div class="space-y-3">
                                        <label for="car_type_id" class="inline-flex cursor-pointer">
                                            <span class="text-white-dark">نوع السيارة <span
                                    ...
                                    <div class="space-y-3">
                                        <label class="inline-flex cursor-pointer">
                                            <span class="text-white-dark">اسم السيارة <span
                                                    class="text-danger">*</span></span>
                                        </label>
                                    ...
                                    <div class="space-y-3">
                                        <label class="inline-flex cursor-pointer">
                                            <span class="text-white-dark">رقم السيارة <span
                                                    class="text-danger">*</span></span>
                                        </label>
                                        <input type="text" name="car_number" id="car_number"
                                            placeholder="أدخل رقم السيارة" value="{{ old('car_number') }}"
                                    ...
                                    <div class="space-y-3">
                                        <label class="inline-flex cursor-pointer">
                                            <span class="text-white-dark">موديل السيارة <span
                                                    class="text-danger">*</span></span>
                                        </label>
                                        <input type="text" name="car_model" id="car_model"
                                            placeholder="أدخل موديل السيارة" value="{{ old('car_model') }}"
                                            class="form-input" required>
                                        @error('car_model')
                                            <div class="text-danger text-sm">{{ $message }}</div>
                                        @enderror
