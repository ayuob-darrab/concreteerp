    <div x-data="customizer">
        ...
        <nav class="fixed bottom-0 top-0 z-[51] w-full max-w-[400px] bg-white p-4 shadow-[5px_0_25px_0_rgba(94,92,154,0.1)] transition-[right] duration-300 ltr:-right-[400px] rtl:-left-[400px] dark:bg-[#0e1726]"
            ...
            <div class="relative pb-5 text-center">
                ...
                <h4 class="mb-1 dark:text-white">مخصص القالب</h4>
                <p class="text-white-dark">قم بتعيين التفضيلات ليتم حفظها لاستخدام المعاينة الحية.</p>
            </div>

            <div class="mb-3 rounded-md border border-dashed border-[#e0e6ed] p-3 dark:border-[#1b2e4b]">
                <h5 class="mb-1 text-base leading-none dark:text-white">نظام الألوان</h5>
                <p class="text-xs text-white-dark">اختر العرض العام: فاتح أو داكن.</p>
            ...
            <div class="mb-3 rounded-md border border-dashed border-[#e0e6ed] p-3 dark:border-[#1b2e4b]">
                <h5 class="mb-1 text-base leading-none dark:text-white">موضع التنقل</h5>
                <p class="text-xs text-white-dark">اختر طريقة التنقل الرئيسية في التطبيق.</p>
                ...
                <div class="mt-5 text-primary">
                    <label class="mb-0 inline-flex">
                        ...
                        <span>شبه داكن (الشريط الجانبي والرأس)</span>
                    </label>
                </div>
            </div>

            <div class="mb-3 rounded-md border border-dashed border-[#e0e6ed] p-3 dark:border-[#1b2e4b]">
                <h5 class="mb-1 text-base leading-none dark:text-white">نمط التخطيط</h5>
                <p class="text-xs text-white-dark">اختر نمط التخطيط الرئيسي لتطبيقك.</p>
            ...
            <div class="mb-3 rounded-md border border-dashed border-[#e0e6ed] p-3 dark:border-[#1b2e4b]">
                <h5 class="mb-1 text-base leading-none dark:text-white">الاتجاه</h5>
                <p class="text-xs text-white-dark">اختر اتجاه التطبيق.</p>
                <div class="mt-3 flex gap-2">
                    <button type="button" class="btn flex-auto"
            ...
            <div class="mb-3 rounded-md border border-dashed border-[#e0e6ed] p-3 dark:border-[#1b2e4b]">
                <h5 class="mb-1 text-base leading-none dark:text-white">نوع شريط التنقل</h5>
                <p class="text-xs text-white-dark">ثابت أو عائم.</p>
            ...
            <div class="mb-3 rounded-md border border-dashed border-[#e0e6ed] p-3 dark:border-[#1b2e4b]">
                <h5 class="mb-1 text-base leading-none dark:text-white">انتقال الموجه</h5>
                <p class="text-xs text-white-dark">حركة المحتوى الرئيسي.</p>
                <div class="mt-3">
                    <select x-model="$store.app.animation" class="form-select border-primary text-primary"
                        @change="$store.app.toggleAnimation()">
                        <option value="">بدون</option>
                        <option value="animate__fadeIn">تلاشي</option>
                        <option value="animate__fadeInDown">تلاشي للأسفل</option>
                        <option value="animate__fadeInUp">تلاشي للأعلى</option>
                        <option value="animate__fadeInLeft">تلاشي لليسار</option>
                        <option value="animate__fadeInRight">تلاشي لليمين</option>
                        <option value="animate__slideInDown">انزلاق للأسفل</option>
                        <option value="animate__slideInLeft">انزلاق لليسار</option>
                        <option value="animate__slideInRight">انزلاق لليمين</option>
                        <option value="animate__zoomIn">تكبير</option>
                    </select>
                </div>
            </div>
        </div>
