...
@section('page-title', 'عرض و ادارة وحدات القياس')
    ...
    <div x-data="multipleTable">
        <div class="panel mt-6">
            <h3 class="mb-5 text-lg font-semibold dark:text-white-light md:absolute md:top-[25px] md:mb-0">
                <div x-data="measurement_units()" class="relative">
                    <!-- زر فتح المودال -->
                            ...
                            <div class="p-6">
                                ...
                                <div class="grid grid-cols-1 gap-6 lg:grid-cols-2">
                                    ...
                                    <div class="flex flex-col sm:flex-row justify-end gap-4 mt-8 border-t pt-4 col-span-2">
                                        ...
                                        <button type="submit" name="active" value="Newmeasurement_units"
            ...
            Alpine.data('multipleTable', () => ({
                ...
                init() {
                    ...
                    const tableData = {!! json_encode(
                        $listmeasurement_units->map(function ($b) {
                            // 'id','name','code',''
                            return [
                                'id' => $b->id,
                                'name' => $b->name,
