...
@section('page-title', 'حسابات الشركات')

@section('content')
    <style>
        /* بطاقات الإحصائيات - متوافقة مع الثيمات */
        .stats-card {
                ...
                <div class="flex items-center gap-4">
                    ...
                    <div class="flex-1">
                        ...
                        <div class="stats-label opacity-75">
                            {{ $stats['total'] > 0 ? round(($stats['active'] / $stats['total']) * 100, 1) : 0 }}% من
                            الإجمالي
                        </div>
                    </div>
                </div>
            ...
            <div class="stats-card card-danger text-white">
                <div class="flex items-center gap-4">
                    ...
                    <div class="flex-1">
                        ...
                        <div class="stats-label opacity-75">
                            {{ $stats['total'] > 0 ? round(($stats['inactive'] / $stats['total']) * 100, 1) : 0 }}% من
                            الإجمالي
                        </div>
                    </div>
                </div>
        ...
        <div class="panel mt-6">
            ...
            <table id="myTable2" class="whitespace-nowrap">
                <caption class="text-lg font-semibold text-gray-700 dark:text-gray-300 mb-2">
                    حسابات الشركات في البرنامج ({{ $stats['total'] }})
                </caption>
            </table>
        </div>
                    ...
                    const tableData = {!! json_encode(
                        $users->map(function ($b) {
                            return [
                                ...
                                'company_code' => $b->CompanyName->name,
