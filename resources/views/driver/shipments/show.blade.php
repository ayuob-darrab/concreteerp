            ...
            <div class="grid grid-cols-1 lg:grid-cols-3 gap-5">
                ...
                <div class="lg:col-span-2 space-y-5">
                    ...
                    <div class="panel">
                        <h5 class="text-lg font-semibold mb-4 flex items-center">
                            <svg class="w-5 h-5 text-primary ltr:mr-2 rtl:ml-2" fill="none" stroke="currentColor"
                                viewBox="0 0 24 24">
                                <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2"
                        ...
                        @if ($shipment->job && ($shipment->job->customer_phone || $shipment->job->location_map_url))
                            <div class="mt-4 flex flex-wrap gap-2">
                                @if ($shipment->job->customer_phone)
                                    ...
                                    <a href="https://wa.me/{{ preg_replace('/[^0-9]/', '', $shipment->job->customer_phone) }}"
                    ...
                    <div class="panel">
                        ...
                        <div class="grid grid-cols-2 md:grid-cols-4 gap-4">
                            ...
                            <div>
                                ...
                                <p class="font-bold text-2xl text-success">
                                    {{ $shipment->actual_quantity ? number_format($shipment->actual_quantity, 1) . ' م³' : '-' }}
                                </p>
                            </div>
                            <div>
                        ...
                        <div class="grid grid-cols-1 md:grid-cols-3 gap-4">
                            @if ($shipment->mixer)
                                <div class="border rounded-lg p-4">
                                    <div class="text-center">
                                        <div
                                            class="w-12 h-12 mx-auto bg-primary/10 rounded-full flex items-center justify-center mb-2">
                            ...
                            @if ($shipment->truck)
                                <div class="border rounded-lg p-4">
                                    <div class="text-center">
                                        <div
                                            class="w-12 h-12 mx-auto bg-info/10 rounded-full flex items-center justify-center mb-2">
                            ...
                            @if ($shipment->pump)
                                <div class="border rounded-lg p-4">
                                    <div class="text-center">
                                        <div
                                            class="w-12 h-12 mx-auto bg-warning/10 rounded-full flex items-center justify-center mb-2">
                ...
                <div class="space-y-5">
                    ...
                    <div class="panel">
                        ...
                        <div class="space-y-4">
                            <div
                                class="flex items-center gap-3 {{ $shipment->departure_time ? 'text-success' : 'text-gray-400' }}">
                                <div
                                    class="w-8 h-8 rounded-full {{ $shipment->departure_time ? 'bg-success' : 'bg-gray-200' }} flex items-center justify-center">
                                    <svg class="w-4 h-4 text-white" fill="none" stroke="currentColor"
                                        viewBox="0 0 24 24">
                                        <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2"
                                            d="M13 9l3 3m0 0l-3 3m3-3H8"></path>
                                    </svg>
                                </div>
                                <div>
                                    <p class="font-semibold">الانطلاق</p>
                                    <p class="text-sm">
                                        {{ $shipment->departure_time ? $shipment->departure_time->format('H:i') : '-' }}
                                    </p>
                                </div>
                            </div>

                            <div
                                class="flex items-center gap-3 {{ $shipment->arrival_time ? 'text-info' : 'text-gray-400' }}">
                                <div
                                    class="w-8 h-8 rounded-full {{ $shipment->arrival_time ? 'bg-info' : 'bg-gray-200' }} flex items-center justify-center">
                                    <svg class="w-4 h-4 text-white" fill="none" stroke="currentColor"
                                        viewBox="0 0 24 24">
                                        <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2"
                                            d="M17.657 16.657L13.414 20.9a1.998 1.998 0 01-2.827 0l-4.244-4.243a8 8 0 1111.314 0z">
                                ...
                                <div>
                                    ...
                                    <p class="text-sm">
                                        {{ $shipment->arrival_time ? $shipment->arrival_time->format('H:i') : '-' }}</p>
                                </div>
                            </div>

                            <div
                                class="flex items-center gap-3 {{ $shipment->work_start_time ? 'text-warning' : 'text-gray-400' }}">
                                <div
                                    class="w-8 h-8 rounded-full {{ $shipment->work_start_time ? 'bg-warning' : 'bg-gray-200' }} flex items-center justify-center">
                                    <svg class="w-4 h-4 text-white" fill="none" stroke="currentColor"
                                        viewBox="0 0 24 24">
                                        <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2"
                                            d="M19.428 15.428a2 2 0 00-1.022-.547l-2.387-.477a6 6 0 00-3.86.517l-.318.158a6 6 0 01-3.86.517L6.05 15.21a2 2 0 00-1.806.547M8 4h8l-1 1v5.172a2 2 0 00.586 1.414l5 5c1.26 1.26.367 3.414-1.415 3.414H4.828c-1.782 0-2.674-2.154-1.414-3.414l5-5A2 2 0 009 10.172V5L8 4z">
                                ...
                                <div>
                                    ...
                                    <p class="text-sm">
                                        {{ $shipment->work_start_time ? $shipment->work_start_time->format('H:i') : '-' }}
                                    </p>
                                </div>
                            </div>

                            <div
                                class="flex items-center gap-3 {{ $shipment->work_end_time ? 'text-success' : 'text-gray-400' }}">
                                <div
                                    class="w-8 h-8 rounded-full {{ $shipment->work_end_time ? 'bg-success' : 'bg-gray-200' }} flex items-center justify-center">
                                    <svg class="w-4 h-4 text-white" fill="none" stroke="currentColor"
                                        viewBox="0 0 24 24">
                                        <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2"
                                ...
                                <div>
                                    ...
                                    <p class="text-sm">
                                        {{ $shipment->work_end_time ? $shipment->work_end_time->format('H:i') : '-' }}</p>
                                </div>
                            </div>

                            <div
                                class="flex items-center gap-3 {{ $shipment->return_time ? 'text-dark' : 'text-gray-400' }}">
                                <div
                                    class="w-8 h-8 rounded-full {{ $shipment->return_time ? 'bg-dark' : 'bg-gray-200' }} flex items-center justify-center">
                                    <svg class="w-4 h-4 text-white" fill="none" stroke="currentColor"
                                        viewBox="0 0 24 24">
                                        <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2"
                                ...
                                <div>
                                    ...
                                    <p class="text-sm">
                                        {{ $shipment->return_time ? $shipment->return_time->format('H:i') : '-' }}</p>
                                </div>
                            </div>
                        </div>
                    </div>
                        ...
                        <div class="panel">
                            ...
                            <div class="space-y-2">
                                @if ($shipment->status === 'planned' || $shipment->status === 'preparing')
                                    <button type="button" @click="updateStatus({{ $shipment->id }}, 'departed')"
                                ...
                                @elseif($shipment->status === 'departed')
                                    <button type="button" @click="updateStatus({{ $shipment->id }}, 'arrived')"
                                ...
                                @elseif($shipment->status === 'arrived')
                                    <button type="button" @click="updateStatus({{ $shipment->id }}, 'working')"
                                ...
                                @elseif($shipment->status === 'working')
                                    <button type="button" @click="updateStatus({{ $shipment->id }}, 'completed')"
                                ...
                                @elseif($shipment->status === 'completed')
                                    <button type="button" @click="updateStatus({{ $shipment->id }}, 'returned')"
