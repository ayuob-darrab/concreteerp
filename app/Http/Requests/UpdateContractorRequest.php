...
class UpdateContractorRequest extends FormRequest
{
    ...
    public function rules(): array
    {
        return [
            ...
            'contractor_type' => ['sometimes', 'required', 'in:individual,company'],
            ...
            // الحظر
            'block_reason' => ['required_if:status,blocked', 'string', 'max:500'],
        ];
    }
    ...
    public function messages(): array
    {
        return [
            ...
            'required_if' => 'حقل :attribute مطلوب عند الحظر',
